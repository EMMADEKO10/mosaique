...
import { PublicArticle, IPublicArticle } from '@/models/PublicArticle'
...
export async function POST(req: NextRequest) {
  try {
    ...
    const slug = await (PublicArticle as Model<IPublicArticle> & { generateUniqueSlug(baseSlug: string): Promise<string> }).generateUniqueSlug(baseSlug)
