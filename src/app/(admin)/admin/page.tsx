...
const stats = [
  ...
  { label: "Artistes", value: 26, delta: "+10 ce mois", icon: <Music className="w-4 h-4 text-violet-600" /> },
] as const
...
const management = [
  ...
  { title: "Artistes", subtitle: "Gérer les artistes", href: "/admin/artists", badgeBg: "bg-violet-500", icon: <Music className="w-6 h-6" /> },
] as const
