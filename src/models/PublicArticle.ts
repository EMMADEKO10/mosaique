...
interface IPublicArticleModel extends Model<IPublicArticle> {
...
export const PublicArticle = mongoose.models.PublicArticle || mongoose.model<IPublicArticle, IPublicArticleModel>('PublicArticle', PublicArticleSchema)
